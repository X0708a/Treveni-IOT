    ...
    setupNavigationLoading() {
        document.querySelectorAll('a[href$=".html"]').forEach(link => {
            link.addEventListener('click', (e) => {
                ...
                if (link.href.includes("WEB APP FOR DIRECTOR")) {
                    toastMessage = "Launching State Director Dashboard...";
                } else if (link.href.includes("WEB APP OF DISTRICT DIRECTOR")) {
                    toastMessage = "Launching District Director Dashboard...";
                } else if (link.href.includes("MOBILE APP FOR FARMER")) {
                    toastMessage = "Launching Farmer Mobile App...";
                } else if (link.href.includes("MOBIILE APP OF VET")) {
                    toastMessage = "Launching Veterinarian Mobile App...";
                } else {
...
// Add CSS for ripple animation and toast
